<x-app-layout>
    <!-- Breadcrumb Start -->
    <div x-data="{ pageName: `List Products` }">
        ...
        <div class="w-full overflow-x-auto">
            <table class="min-w-full">
                ...
                <thead class="bg-gray-200">
                    <tr class="border-gray-500 border-y dark:border-gray-800 text-center">
                         <th class=" text-center py-3 w-12">
                            <div class="">
                                <p class="font-bold text-gray-700 text-theme-xs dark:text-gray-400">
                                    ID
                                </p>
                            </div>
                        </th>
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                    ...
                    @foreach ($products as $product)
                        <tr>
                            <td class="py-3">
                                <div class="w-8 h-8 m-auto flex flex-col rounded-full items-center justify-center bg-gray-800">

                                    <span class="block text-sm text-white" >{{$product->id}}</span>
                                </div>
                            </td>
                            <td class="py-3">
                                <img src="{{ $product->image }}" alt="" class="w-20 h-20 m-auto rounded-xl object-cover">
                            </td>
                             <td class="py-3">
                            ...
                            <td class="py-3">
                                <div class="flex flex-row items-center  gap-2">
                                    <div>
                                        @if($product->category->parent)
                                            <span
                                                class="rounded-full bg-error-50 py-0.5 pl-2 pr-2.5 text-sm font-medium text-error-600 dark:bg-error-500/15 dark:text-error-500">
                                        ...
                                        @endif
                                            ...
                                            <span
                                                class="rounded-full bg-success-50 py-0.5 pl-2 pr-2.5 text-sm font-medium text-success-600 dark:bg-success-500/15 dark:text-success-500">
                             ...
                             <td class="py-3">
                                  <p class="font-medium text-gray-800 text-theme-sm dark:text-white/90">{{ $product->created_at?->format('d/m/Y') }}</p>
                            </td>
                              <td class="py-3">
                                 <p class="font-medium text-gray-800 text-theme-sm dark:text-white/90"> {{ $product->updated_at?->format('d/m/Y') }}</p>
                            </td>
                            ...
                            <td class="py-3">
                                <div class="flex items-center gap-2">
                                    ...
                                    <form action="{{ route('admin.products.destroy', $product->id) }}" method="POST">
                                        ...
                                        <a href="{{ route('admin.products.destroy', $product->id) }}" onclick="event.preventDefault();
