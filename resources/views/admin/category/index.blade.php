<x-app-layout>
    <!-- Breadcrumb Start -->
    <div x-data="{ pageName: `List Categories` }">
                    ...
                    @foreach ($categories as $category)
                        <tr>
                            <td class="py-3">
                             ...
                             <td class="py-3">
                                 <p class="font-medium text-gray-800 text-theme-sm dark:text-white/90">{{ $category->slug }}</p>
                            </td>
                            ...
                            <td class="py-3">
                                <div class="flex items-center">
                                    <div>
                                        @if($category->parent)
                                            <span
                                                class="inline-flex items-center justify-center gap-1 rounded-full bg-success-500 px-2.5 text-sm font-medium text-white dark:bg-white/5 dark:text-white">
                            ...
                            <td>
                                  <p class="font-medium text-gray-800 text-theme-sm dark:text-white/90">{{ $category->created_at?->format('d/m/Y') }}</p>
                            </td>
                             <td>
                                 <p class="font-medium text-gray-800 text-theme-sm dark:text-white/90"> {{ $category->updated_at?->format('d/m/Y') }}</p>
                            </td>
                            ...
                            <td class="py-3">
                                <div class="flex items-center gap-2">
                                    ...
                                    <form action="{{ route('admin.categories.destroy', $category->id) }}" method="POST">
                                        ...
                                        <a href="{{ route('admin.categories.destroy', $category->id) }}" onclick="event.preventDefault();
